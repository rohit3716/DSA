...
class Node {
    ...
    ~Node() {
        ...
        cout<<endl<< "memory free for node with data  "<< val << endl;
    }
};
...
int main() {
    ...
    insertAtPosition(tail,head,1,27);
    print(head);

    insertAtPosition(tail,head,4,29);
    print(head);
    ...
    cout << endl << "Length of node is: "<< getLength(head) << endl;
    return 0;
